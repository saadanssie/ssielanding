...
export const PersonalAIAgent = () => {
  ...
  return (
    <div className="relative z-20 px-4 md:px-6 max-w-5xl mx-auto w-full">
      <div className="bg-[#ffff]/15 p-7 rounded-3xl border border-white/30 shadow-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {agents.map((agent, i) => (
            <div key={i} className="bg-white p-4 rounded-[8px] group hover:-translate-y-1 transition-all duration-300">
